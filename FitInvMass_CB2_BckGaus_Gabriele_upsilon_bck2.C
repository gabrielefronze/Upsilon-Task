...
void FitInvMass_CB2_BckGaus_Gabriele_upsilon_bck2(TString inputFile, TString histoName, Int_t rebinFactor=1, Double_t FitMin=7., Double_t FitMax=12., char *period = "LHC15o", char *tailsfix="yes"){
...
Double_t par[12]={1.,-1.,1.,-1.,19.,UpsilonMass,10.0e-02,1.00011e+00,3.70078e+00,1.68359e+00,3.63002e+00,0.01}; 
TF1 *funcbck;
...
funcUpsilon->SetParLimits(5,UpsilonMass-UpsilonMass*0.1,UpsilonMass+UpsilonMass*0.05);
...
functot->SetParLimits(5,UpsilonMass-UpsilonMass*0.5,UpsilonMass+UpsilonMass*0.5);
...
Double_t FuncBck(Double_t *x, Double_t *par){
  ...
  Double_t FitBck = par[0]*TMath::Power(x[0],par[1])+par[2]*TMath::Power(x[0],par[3]);
  return FitBck;
}
