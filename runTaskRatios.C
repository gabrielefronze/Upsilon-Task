int runTaskRatios (TString runMode="",TString analysisMode="",TString inputName="",TString inputOptions="",TString softVersions="",TString analysisOptions="",TString taskOptions=""){
  ...
  SetupAnalysis(runMode,analysisMode,inputName,inputOptions,softVersions,analysisOptions, "libPWGmuon.so AliAnalysisTaskRatios.cxx AddTaskRatios.C",". $ALICE_ROOT/include $ALICE_PHYSICS/include","UpsilonTaskOutputRatios");
  ...
  AliAnalysisTaskRatios* taskMy = AddTaskRatios(isMC, "first");
