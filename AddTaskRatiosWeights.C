...
AliAnalysisTaskWeightedSpectrum* AddTaskRatiosWeights(Bool_t isMC = kFALSE, TString inputFilelName, TString mode, TString changeName = "")
{
  ...
  AliAnalysisTaskWeightedSpectrum *ratiosAnalysisTask = new AliAnalysisTaskWeightedSpectrum(muonCuts,isMC,inputFilelName,mode);
