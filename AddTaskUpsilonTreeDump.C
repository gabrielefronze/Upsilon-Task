...
AliAnalysisTaskUpsilonTreeDump* AddTaskUpsilonTreeDump(Bool_t isMC = kFALSE, TString changeName = "")
{
  ...
  AliAnalysisTaskUpsilonTreeDump *upsilonAnalysisTask = new AliAnalysisTaskUpsilonTreeDump(taskName.Data(),muonCuts);
