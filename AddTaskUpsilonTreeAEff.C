...
AliAnalysisTaskUpsilonTreeAEff* AddTaskUpsilonTreeAEff(Bool_t isMC, TString changeName = "")
{
  ...
  AliAnalysisTaskUpsilonTreeAEff *upsilonAnalysisTask = new AliAnalysisTaskUpsilonTreeAEff(taskName.Data(),muonCuts,isMC);
