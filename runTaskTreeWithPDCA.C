int runTaskTreeWithPDCA (TString runMode="",TString analysisMode="",TString inputName="",TString inputOptions="",TString softVersions="",TString analysisOptions="",TString taskOptions=""){
  ...
  SetupAnalysis(runMode,analysisMode,inputName,inputOptions,softVersions,analysisOptions, "libPWGmuon.so AliAnalysisTaskUpsilonTree.cxx AddTaskUpsilonTree.C",". $ALICE_ROOT/include $ALICE_PHYSICS/include","UpsilonTaskOutputFullWithPDCA");
