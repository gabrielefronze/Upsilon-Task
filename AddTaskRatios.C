...
AliAnalysisTaskRatios* AddTaskRatios(Bool_t isMC = kFALSE, TString changeName = "")
{
  ...
  AliAnalysisTaskRatios *ratiosAnalysisTask = new AliAnalysisTaskRatios(taskName.Data(),muonCuts);
