#ifndef AliAnalysisTaskUpsilonTreeTuned_H
#define AliAnalysisTaskUpsilonTreeTuned_H
...
class AliAnalysisTaskUpsilonTreeTuned : public AliAnalysisTaskSE
{
  public:
    virtual void NotifyRun();
    
    AliAnalysisTaskUpsilonTreeTuned();
    AliAnalysisTaskUpsilonTreeTuned(const char *name, AliMuonTrackCuts *cuts);
    virtual ~AliAnalysisTaskUpsilonTreeTuned();
  ...
  ClassDef(AliAnalysisTaskUpsilonTreeTuned,1);
};
